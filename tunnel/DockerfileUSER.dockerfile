...
COPY scripts/ssh_tunnel.exp ${user_dir}/ssh_tunnel.exp
COPY scripts/handle_keys.exp ${user_dir}/handle_keys.exp
COPY scripts/tunnel_check.sh ${user_dir}/tunnel_check.sh
...
RUN chmod +x /docker-entrypoint.sh && \
    chmod +x ${user_dir}/ssh_tunnel.exp && \
    chmod +x ${user_dir}/handle_keys.exp && \
    chmod +x ${user_dir}/tunnel_check.sh && \
